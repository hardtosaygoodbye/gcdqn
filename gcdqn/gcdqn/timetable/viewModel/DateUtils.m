...
+ (NSArray *)getDatesOfCurrence
{
    ...
    NSDateComponents *components = [calendar components:NSYearCalendarUnit|NSMonthCalendarUnit|NSDayCalendarUnit|NSWeekdayCalendarUnit fromDate:now];
    ...
    for (int i = 0; i< 7; i++) {
        ...
        components = [calendar components:NSYearCalendarUnit|NSMonthCalendarUnit|NSDayCalendarUnit|NSWeekdayCalendarUnit fromDate:everyDate];
...
+ (NSArray *)getDatesSinceCurence:(int)weeks
{
    ...
    for (int i = 0; i< 7; i++) {
        [components setDay:[firstDayComp day] + i];
        NSDate *everyDate = [calendar dateFromComponents:components];
        NSDateComponents *everCom = [calendar components:NSYearCalendarUnit|NSMonthCalendarUnit|NSDayCalendarUnit|NSWeekdayCalendarUnit fromDate:everyDate];
